...
class solution1 {
    ...
    public boolean one1_1(String str) {
    ...
    // solution 2
    // time complexity O(n) with n is the length of the string
    // space complexity is reduced by a factor of 8 using a single int variable
    // instead of an array
    public boolean one1_2(String str) {
